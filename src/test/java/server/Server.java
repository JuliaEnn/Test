...
public class Server {
    ...
    public static void main(String[] args) {
        ...
        HttpContext context4 = server.createContext("/counter", new Server.EchoHandler4());
    ...
    static class EchoHandler3 implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            Date date = new Date();
            builder.append("Текущая дата и время:");
            builder.append('\n');
    ...
    static class EchoHandler4 implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            counter++;
            builder.append("Количество посещений данной страницы:");
            builder.append('\n');
